...
for i in range(0, lenght, 5):
    print('{}c. кан0:{} = {} base = {}{} {}c. кан90: {} = {} base = {}{}\n'.format(print_buff0[i], str(print_buff0[i + 1]), str(print_buff0[i + 2]), str(print_buff0[i + 3]), str(print_buff0[i + 4]),
                                                           print_buff90[i], str(print_buff90[i + 1]), str(print_buff90[i + 2]), str(print_buff90[i + 3]), str(print_buff90[i + 4])))
    print("~" * 86)
print("\n")
print("*----------------------------------------------------------------*")
...
print("*----------------------------------------------------------------*")
print("Частота сэмплирования на входе " + "\x1b[32m" + str(fs) +"\x1b[0m" + " Hz")
print("Частота сэмплирования после интеграторов " + "\x1b[32m" + str(Fs) + "\x1b[0m" +" Hz")
print("*----------------------------------------------------------------*")
print("время симуляции   " + "\x1b[32m" + str(T) + "\x1b[0m"+" сек.")
time2 = str('{:.2f}'.format(time2))
print("время выполнения основного цикла " + "\x1b[32m" + str(time2) + "\x1b[0m" + " сек.")
time1 = str('{:.2f}'.format(time1))
print("общее время выполнения " + "\x1b[32m" + str(time1) + "\x1b[0m" + " сек.")
print("*----------------------------------------------------------------*")
print("Всего передано бит " + "\x1b[32m" + str(counter_total) + "\x1b[0m")
print("Верно принятых бит " + "\x1b[32m" + str(counter_suc) + "\x1b[0m")
print("*----------------------------------------------------------------*")

#print("Задержка приема первого байта " + "\x1b[32m" + str(t_reaction) + "\x1b[0m" + " сек.")
#print("*----------------------------------------------------------------*")

print("Амплитуда сигнала " + "\x1b[32m" + str(A_input) + "\x1b[0m" + " отсчетов")
print("*----------------------------------------------------------------*")
print("Соотношение сигнал/шум " + "\x1b[32m" + str(s_n) + "\x1b[0m" + " dB")
print("*----------------------------------------------------------------*")
